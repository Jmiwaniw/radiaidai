        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-16">
          {pillars.map((pillar, index) => (
            <ScrollReveal key={pillar.title} delay={index * 100}>
              <div
                className="group p-8 rounded-2xl bg-primary-foreground/5 backdrop-blur-sm border border-primary-foreground/10 hover:border-teal/50 transition-all duration-300 hover:bg-primary-foreground/10 h-full"
              >
