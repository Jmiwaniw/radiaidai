import { Cpu, Eye, Gauge, Zap, Shield, Smartphone } from "lucide-react";
      ...
      <div className="container px-4 md:px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="group p-6 rounded-2xl bg-card border border-border hover:border-sky/30 transition-all duration-300 hover:shadow-soft"
            >
